...
kedacore/keda                                   2.20.0          2.20.0          Event-based autoscaler for workloads on Kubernetes
kedacore/keda-add-ons-http                      0.14.1          0.14.0          Event-based autoscaler for HTTP workloads on Ku...
```
