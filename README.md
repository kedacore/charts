...
kedacore/keda                                   2.18.3          2.18.3          Event-based autoscaler for workloads on Kubernetes
kedacore/keda-add-ons-http                      0.11.1          0.11.1          Event-based autoscaler for HTTP workloads on Ku...
```
