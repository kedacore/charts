...
kedacore/keda                                   2.20.1          2.20.1          Event-based autoscaler for workloads on Kubernetes
kedacore/keda-add-ons-http                      0.15.0          0.15.0          Event-based autoscaler for HTTP workloads on Ku...
```
